...
<div x-data="{
 ...
 class="flex cursor-pointer flex-col items-center gap-[7px] rounded-lg border-[1.5px] border-dashed bg-fill-4 px-5 py-7 text-center transition-colors duration-[--dur-fast]"
        ...
        <span class="text-sm text-ink-muted" x-text="files.length ? files.join(', ') : @js($hint ?? 'Maksimal 10 MB per berkas')">
