...
<div {{ $attributes->class('flex flex-col items-center justify-center gap-1.5 px-6 py-12 text-center') }}>
    <div class="mb-1.5 flex size-11 items-center justify-center rounded-lg bg-fill-4 text-ink-muted ">
    ...
    @if ($description)
        <p class="max-w-[36ch] text-base text-ink-secondary">{{ $description }}</p>
    @endif
