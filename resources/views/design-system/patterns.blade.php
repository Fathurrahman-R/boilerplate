...
<x-layouts.docs title="Pola &amp; panduan" :nav="$nav">
    ...
    <x-docs.section id="layout" number="16" eyebrow="Pola Layout">
        <div class="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-lg border border-line bg-surface-raised p-4">
                ...
                <h4 class="text-body font-semibold text-ink">Shell aplikasi</h4>
                <p class="mt-1 text-base text-ink-secondary">Sidebar kaca + topbar kaca mengambang, berpadding 16px, konten fluid.</p>
            </div>
            ...
            <div class="rounded-lg border border-line bg-surface-raised p-4">
                ...
                <h4 class="text-body font-semibold text-ink">Baris metrik</h4>
                <p class="mt-1 text-base text-ink-secondary">Tiga sampai empat kartu kaca di paling atas dashboard.</p>
            </div>
            ...
            <div class="rounded-lg border border-line bg-surface-raised p-4">
                ...
                <h4 class="text-body font-semibold text-ink">Daftar + panel detail</h4>
                <p class="mt-1 text-base text-ink-secondary">Pola utama internal tools. Panel kanan 380–420px.</p>
            </div>
            ...
            <div class="rounded-lg border border-line bg-surface-raised p-4">
                ...
                <h4 class="text-body font-semibold text-ink">Auth split</h4>
                <p class="mt-1 text-base text-ink-secondary">Masuk/Daftar saja. Form solid + panel kaca kepercayaan, hilang di bawah <code class="font-mono text-xs">lg</code>.</p>
            </div>
        </div>
    </x-docs.section>
    ...
    <x-docs.section id="voice" number="17" eyebrow="Voice &amp; Tone" title="Tenang, langsung, tidak menggurui">
        <div class="overflow-hidden rounded-lg border border-line">
            <div class="grid grid-cols-2 gap-px bg-line">
                <div class="bg-surface-sunken px-4 py-3 font-mono text-2xs tracking-[0.08em] text-success">TULIS BEGINI</div>
                <div class="bg-surface-sunken px-4 py-3 font-mono text-2xs tracking-[0.08em] text-danger">BUKAN BEGINI</div>
 ...
 lead="Warna didefinisikan sekali sebagai CSS variable, lalu dipetakan ke nama semantik di blok @theme. Ganti tema cukup dengan mengubah data-theme di elemen html — tidak ada kelas dark: yang berserakan.">
        ...
        <div class="overflow-hidden rounded-md border border-line">
            <pre class="overflow-x-auto bg-code p-5 font-mono text-sm leading-relaxed text-code-ink"><code>/* resources/css/app.css */
...
@theme inline {
 ...
 --color-accent: var(--accent);
        ...
        <div class="mt-4 grid gap-3.5 sm:grid-cols-2">
            <div class="rounded-md border border-line bg-surface-raised p-4">
                <h4 class="text-body font-semibold text-ink">Utility yang perlu diingat</h4>
                <ul class="mt-2.5 space-y-1.5 text-base text-ink-secondary">
                    <li><code class="font-mono text-sm">glass</code> — panel mengambang di atas latar bertekstur</li>
                    <li><code class="font-mono text-sm">material</code> + <code class="font-mono text-sm">data-mat</code> — lima tingkat material</li>
                    <li><code class="font-mono text-sm">bg-shell</code> / <code class="font-mono text-sm">bg-glow</code> — lapisan latar</li>
                    <li><code class="font-mono text-sm">num</code> — angka mono dengan digit tabular</li>
                    <li><code class="font-mono text-sm">eyebrow</code> — label mono huruf besar</li>
                    <li><code class="font-mono text-sm">form-check</code> — kotak centang di markup sendiri</li>
                </ul>
            </div>

            <div class="rounded-md border border-line bg-surface-raised p-4">
                <h4 class="text-body font-semibold text-ink">Mengganti warna aksen</h4>
                <p class="mt-2.5 text-base text-ink-secondary">
                    Satu project turunan biasanya cuma perlu mengganti aksen. Ubah <code class="font-mono text-sm">--accent</code>,
                    <code class="font-mono text-sm">--accent-hover</code>, <code class="font-mono text-sm">--accent-soft</code>,
 dan <code class="font-mono text-sm">--mat-accent</code> di kedua blok tema — sisanya ikut sendiri.
                </p>
                <p class="mt-2.5 text-base text-ink-secondary">
                    <code class="font-mono text-sm">--accent-on</code> adalah warna teks di atas aksen; pastikan
 ...
 class="group rounded-lg border border-line bg-surface-raised p-5 transition hover:border-line-strong">
                    ...
                    <h4 class="mt-2 text-lg font-semibold text-ink">{{ $meta['title'] }}</h4>
                    <p class="mt-1.5 text-base text-ink-secondary">{{ $meta['summary'] }}</p>
                    <span class="mt-3.5 inline-flex items-center gap-1.5 text-sm text-link">
                        Buka layar
