...
<x-docs.screen :screen="$screen" :meta="$meta" url="app.contoh.id/pengaturan" backdrop="shell">
    <div class="flex min-h-[720px] flex-col lg:flex-row">
        ...
        <div class="min-w-0 flex-1 p-6">
            <div class="mx-auto max-w-[720px] space-y-6">
                <div>
                    <h1 class="text-2xl font-semibold text-ink">Umum</h1>
 ...
 hint="Dalam hari, dihitung sejak tanggal jatuh tempo." />
                        ...
                        <div>
                            <span class="mb-1.5 block text-sm font-semibold text-ink">Nilai yang butuh persetujuan</span>
 ...
 dan tidak pernah bersebelahan dengan tombol simpan. --}}
                <x-ui.card>
                    <div class="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            <h2 class="text-base font-semibold text-ink">Tutup workspace</h2>
