<x-docs.screen :screen="$screen" :meta="$meta" url="app.contoh.id/masuk">
        ...
        <div class="flex flex-col justify-center bg-surface-raised px-6 py-12 sm:px-12 lg:py-14">
            <div class="mx-auto w-full max-w-[360px]">
                <div class="mb-9 flex items-center gap-2.5">
                    <span class="flex size-[26px] items-center justify-center rounded-sm bg-accent text-sm font-bold text-accent-on">N</span>
                    <span class="text-base font-semibold tracking-tight text-ink">Nusatagih</span>
                </div>

                <h1 class="text-3xl font-semibold text-ink">Masuk ke workspace</h1>
                ...
                <div class="mt-7 space-y-4">
                    ...
                    <div>
                        <div class="mb-1.5 flex items-baseline justify-between gap-3">
                            <span class="text-sm font-semibold text-ink">Kata sandi</span>
                            <span class="text-sm text-link">Lupa kata sandi?</span>
                        </div>
                        <input type="password" value="tidakbenar" aria-label="Kata sandi"
 class="block h-control w-full rounded-md border border-danger bg-surface-sunken px-3 text-sm text-ink outline-none">
 ...
 ['value' => '99,9%', 'label' => 'uptime'],
    ...
    <div class="border-t border-line bg-surface-raised px-9 py-5">
        <div class="flex items-start gap-3">
            ...
            <p class="max-w-[70ch] text-sm text-ink-secondary">
                Verifikasi dua langkah aktif untuk workspace ini. Setelah kata sandi benar, pengguna diminta kode
 enam digit dari aplikasi autentikator — komponen <code class="font-mono text-sm">x-layouts.guest</code>
