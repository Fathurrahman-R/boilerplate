...
<x-docs.screen :screen="$screen" :meta="$meta" url="app.contoh.id/ringkasan" backdrop="shell">
    <div class="flex min-h-[720px] gap-4 p-4">
        ...
        <aside class="glass hidden w-56 shrink-0 flex-col gap-0.5 self-start rounded-xl p-3 lg:flex">
            <div class="mb-2 flex items-center gap-2.5 px-1.5 py-1">
                <span class="flex size-6 items-center justify-center rounded-sm bg-accent text-sm font-bold text-accent-on">N</span>
            ...
            <div class="flex items-center gap-2.5 px-2 py-1.5">
                <span class="flex size-[26px] items-center justify-center rounded-full border border-line bg-surface-inset text-2xs font-semibold text-ink-secondary">RA</span>
                <div class="min-w-0">
                    <div class="truncate text-sm font-semibold text-ink">Rangga A.</div>
                    <div class="text-xs text-ink-muted">Keuangan</div>
                </div>
            </div>
        </aside>
        ...
        <div class="min-w-0 flex-1 space-y-4">
                    ...
                    <div class="flex h-40 items-end gap-3">
                        @foreach ($bars as $bar)
                            <div class="flex h-full flex-1 flex-col items-center justify-end gap-2">
                                ...
                                <span class="font-mono text-2xs text-ink-muted">{{ $bar['label'] }}</span>
                            </div>
                        @endforeach
                    </div>
                </x-ui.card>
                    ...
                    <div class="space-y-3.5">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-ink-secondary">Total Rp 9.840.000 dari dua klien.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-ink-secondary">Penagihan berikutnya akan gagal.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-ink-secondary">Rata-rata menunggu 2 hari.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-3">
                <div class="flex flex-wrap items-center gap-3">
                    <h2 class="flex-1 text-base font-semibold text-ink">Faktur terbaru</h2>
 ...
 class="h-9 w-52 rounded-md border border-line bg-surface-sunken ps-9 pe-3 text-base text-ink outline-none placeholder:text-ink-muted focus:border-accent focus:shadow-[var(--focus-ring)]">
                    </div>
                ...
                <x-ui.table :headers="['Faktur', 'Klien', 'Status', 'Jatuh tempo', 'Nilai']">
                    @foreach ($rows as $row)
                        <x-ui.table.row>
                            ...
                            <x-ui.table.cell class="num text-sm text-ink-muted">
