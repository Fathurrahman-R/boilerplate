...
@php
    $tombol = 'inline-flex h-[30px] min-w-[30px] items-center justify-center rounded-sm border-[0.5px] border-line bg-fill-3 px-2 text-sm text-ink-secondary shadow-sm transition hover:bg-fill-2 ';
    $mati = 'inline-flex h-[30px] min-w-[30px] cursor-not-allowed items-center justify-center rounded-sm border border-line bg-surface-sunken px-2 text-sm text-ink-muted ';
    $aktif = 'inline-flex h-[30px] min-w-[30px] items-center justify-center rounded-sm border border-transparent bg-accent px-2 text-sm font-semibold text-accent-on shadow-sm';
@endphp
